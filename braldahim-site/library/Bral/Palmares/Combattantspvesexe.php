 ...
 * $LastChangedBy$
 */
class Bral_Palmares_Combattantspvesexe extends Bral_Palmares_Box {
	...
	function getNomInterne() {
		return "box_onglet_combattantspvesexe";		
	}
	
	function getNomClasse() {
		return "combattantspvesexe";		
	}
	...
	function render() {
		...
		$this->prepare();
		return $this->view->render("palmares/combattantspve_sexe.phtml");
	}
