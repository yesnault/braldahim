 ...
 * $LastChangedBy$
 */
class Bral_Palmares_Combattantspvpsexe extends Bral_Palmares_Box {
	...
	function getNomInterne() {
		return "box_onglet_combattantspvpsexe";		
	}
	...
	function render() {
		...
		$this->prepare();
		return $this->view->render("palmares/combattantspvp_sexe.phtml");
	}
