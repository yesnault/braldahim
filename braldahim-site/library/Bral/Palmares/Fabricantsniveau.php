...
class Bral_Palmares_Fabricantsniveau extends Bral_Palmares_Box {
	...
	private function prepare() {
		if ($this->view->type == "bucheronsroutes") {
			...
			$rowset = $statsTable->findByNiveau($mdate["dateDebut"], $mdate["dateFin"], $this->view->type);
			...
			$rowset = $statsFabricantsTable->findByNiveau($mdate["dateDebut"], $mdate["dateFin"], $this->view->type);
			$this->view->niveaux = $rowset;
		}
