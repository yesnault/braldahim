 ...
 * $LastChangedBy$
 */
class Bral_Palmares_Fabricantsfamille extends Bral_Palmares_Box {
	...
	private function prepare() {
		if ($this->view->type == "bucheronsroutes") {
			...
			$rowset = $statsTable->findByFamille($mdate["dateDebut"], $mdate["dateFin"], $this->view->type);
			...
			$rowset = $statsFabricantsTable->findByFamille($mdate["dateDebut"], $mdate["dateFin"], $this->view->type);
			$this->view->familles = $rowset;
		}
	}
}