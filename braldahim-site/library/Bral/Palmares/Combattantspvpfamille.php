 ...
 * $LastChangedBy$
 */
class Bral_Palmares_Combattantspvpfamille extends Bral_Palmares_Box {
	...
	function getNomInterne() {
		return "box_onglet_combattantspvpfamille";		
	}
	...
	function render() {
		...
		$this->prepare();
		return $this->view->render("palmares/combattantspvp_famille.phtml");
	}
