                    ...
                    if ($cadavres != null) {
                        foreach ($cadavres as $c) {
                            if ($display_x == $c["x_monstre"] && $display_y == $c["y_monstre"]) {
                                ...
                                if ($c['id_fk_type_groupe_monstre'] == $this->config->game->groupe_monstre->type->gibier) {
                                    $estGibier = "oui";
                                } else {
                                    $estGibier = "non";
                                }
                                $retour .= 'CADAVRE;' . $pos . ';' . $c["id_monstre"] . ';' . $c["nom_type_monstre"] . ';' . $c_taille . ';' . $c["id_type_monstre"] . ";" . $estGibier . $fin;
                            }
                        }
                    }
                    ...
                    if ($elements != null) {
                        foreach ($elements as $e) {
                            if ($display_x == $e["x_element"] && $display_y == $e["y_element"]) {
                                if ($e["quantite_peau_element"] > 0) $retour .= 'ELEMENT;' . $pos . ';Peau;' . $e["quantite_peau_element"] . ';x;' . $e['id_fk_butin_element'] . $fin;
                                if ($e["quantite_cuir_element"] > 0) $retour .= 'ELEMENT;' . $pos . ';Cuir;' . $e["quantite_cuir_element"] . ';s;' . $e['id_fk_butin_element'] . $fin;
                                if ($e["quantite_fourrure_element"] > 0) $retour .= 'ELEMENT;' . $pos . ';Fourrure;' . $e["quantite_fourrure_element"] . ';s;' . $e['id_fk_butin_element'] . $fin;
                                if ($e["quantite_planche_element"] > 0) $retour .= 'ELEMENT;' . $pos . ';Planche;' . $e["quantite_planche_element"] . ';s;' . $e['id_fk_butin_element'] . $fin;
                                if ($e["quantite_rondin_element"] > 0) $retour .= 'ELEMENT;' . $pos . ';Rondin;' . $e["quantite_rondin_element"] . ';s;' . $e['id_fk_butin_element'] . $fin;
                                if ($e["quantite_castar_element"] > 0) $retour .= 'ELEMENT;' . $pos . ';Castar;' . $e["quantite_castar_element"] . ';s;' . $e['id_fk_butin_element'] . $fin;
                            }
                        }
                    }
                    ...
                    if ($elementsRunes != null) {
                        foreach ($elementsRunes as $r) {
                            if ($display_x == $r["x_element_rune"] && $display_y == $r["y_element_rune"]) {
                                $retour .= 'RUNE;' . $pos . ';' . $r["id_rune_element_rune"] . ";" . $r['id_fk_butin_element_rune'] . $fin;
                            }
                        }
                    }
                    ...
                    if ($monstres != null) {
                        foreach ($monstres as $m) {
                            if ($display_x == $m["x_monstre"] && $display_y == $m["y_monstre"]) {
                                ...
                                if ($m['id_fk_type_groupe_monstre'] == $this->config->game->groupe_monstre->type->gibier) {
                                    $estGibier = "oui";
                                } else {
                                    $estGibier = "non";
                                }
                                $retour .= 'MONSTRE;' . $pos . ';' . $m["id_monstre"] . ';' . $m["nom_type_monstre"] . ';' . $m_taille . ';' . $m["id_type_monstre"] . ";" . $estGibier . $fin;
                            }
                        }
                    }
