 ...
 *
 * $Id: CharretteMunition.php 2019 2009-09-19 10:32:13Z yvonnickesnault $
...
class CharretteMunition extends Zend_Db_Table {
	...
	protected $_primary = array('id_fk_braldun_charrette_munition', 'id_fk_type_charrette_munition');
