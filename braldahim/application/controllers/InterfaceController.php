...
class InterfaceController extends Zend_Controller_Action {
	...
	function boxesAction() {
		...
		$this->addBox(Bral_Box_Factory::getLaban($this->_request, $this->view, false), "boite_a");
	...
	private function refreshAll() {
		$boxToRefresh = array("box_profil", "box_metier", "box_equipement", "box_vue", "box_lieu", "box_competences_communes", "box_competences_basiques", "box_competences_metiers");
