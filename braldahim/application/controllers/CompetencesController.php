	...
	function init() {
		...
		if (!Zend_Auth::getInstance()->hasIdentity() || $this->_request->get("dateAuth") != $this->view->user->dateAuth ) {
			if (!Zend_Auth::getInstance()->hasIdentity() ) {
				Bral_Util_Log::tech()->warn("CompetencesController - logoutajax 1 - Perte Session");
			} else {
				Bral_Util_Log::tech()->warn("CompetencesController - logoutajax 2 - dateAuth=".$this->_request->get("dateAuth") . " dateAuth2=".$this->view->user->dateAuth);
			}
