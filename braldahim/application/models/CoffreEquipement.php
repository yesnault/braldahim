 ...
 *
 * $Id: LabanEquipement.php 595 2008-11-09 11:21:27Z yvonnickesnault $
...
class CoffreEquipement extends Zend_Db_Table {
	...
	function findByIdHobbit($id_hobbit) {
		...
		->where('id_fk_recette_coffre_equipement = id_recette_equipement')
		...
		->joinLeft('mot_runique','id_fk_mot_runique_coffre_equipement = id_mot_runique');
