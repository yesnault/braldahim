...
class Bral_Helper_BBBoutons {
	...
	public static function affiche($champ, $nbMax = 2500) {
		...
		$retour .='						<td>&nbsp;</td>';
		$retour .='						<td><img alt="very small" src="/public/images/uddeim/format_size1.gif" style="cursor: pointer;" name="addbbcode12" onclick="bbstyle(12, $(\''.$champ.'\')); textCount($(\''.$champ.'\'),$(\'characterstyped\'),'.$nbMax.'); return false;" title="Tags BB Code pour définir du texte de petite taille. Utilisation : [size=1]texte de petite taille.[/size]"></td>';
		$retour .='						<td><img alt="small" src="/public/images/uddeim/format_size2.gif" style="cursor: pointer;" name="addbbcode14" onclick="bbstyle(14, $(\''.$champ.'\')); textCount($(\''.$champ.'\'),$(\'characterstyped\'),'.$nbMax.'); return false;" title="Tags BB Code pour définir du texte de grande taille 2. Utilisation : [size=2]texte de grande taille 2.[/size]"></td>';
		$retour .='						<td><img alt="large" src="/public/images/uddeim/format_size2.gif" style="cursor: pointer;" name="addbbcode16" onclick="bbstyle(16, $(\''.$champ.'\')); textCount($(\''.$champ.'\'),$(\'characterstyped\'),'.$nbMax.'); return false;" title="Tags BB Code pour définir du texte de grande taille 3. Utilisation : [size=3]texte de grande taille 3.[/size]"></td>';
		$retour .='						<td><img alt="very large" src="/public/images/uddeim/format_size4.gif" style="cursor: pointer;" name="addbbcode18" onclick="bbstyle(18, $(\''.$champ.'\')); textCount($(\''.$champ.'\'),$(\'characterstyped\'),'.$nbMax.'); return false;" title="Tags BB Code pour définir du texte de grande taille 4. Utilisation : [size=4]texte de grande taille 4.[/size]"></td>';
		$retour .='						<td><img alt="very large" src="/public/images/uddeim/format_size5.gif" style="cursor: pointer;" name="addbbcode18" onclick="bbstyle(20, $(\''.$champ.'\')); textCount($(\''.$champ.'\'),$(\'characterstyped\'),'.$nbMax.'); return false;" title="Tags BB Code pour définir du texte de grande taille 5. Utilisation : [size=5]texte de grande taille 5.[/size]"></td>';
		$retour .='						<td>&nbsp;</td>';
