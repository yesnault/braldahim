...
class Bral_Helper_BBBoutons {
	...
	public static function affiche($champ, $nbMax = 2500) {
		...
		$retour .='					</tr>';
		$retour .='					<tr>';
		$retour .='						<td><img alt="gauche" src="/public/images/uddeim/format_left.gif" style="cursor: pointer;" name="addbbcode0" onclick="bbstyle(32, $(\''.$champ.'\')); textCount($(\''.$champ.'\'),$(\'characterstyped\'),'.$nbMax.'); return false;" title="Tags BB Code pour définir du texte à gauche. Utilisation : [left]texte[/left]"></td>';
		$retour .='						<td><img alt="centré" src="/public/images/uddeim/format_center.gif" style="cursor: pointer;" name="addbbcode2" onclick="bbstyle(34, $(\''.$champ.'\')); textCount($(\''.$champ.'\'),$(\'characterstyped\'),'.$nbMax.'); return false;" title="Tags BB Code pour définir du texte centré. Utilisation : [center]texte[/center]"></td>';
		$retour .='						<td><img alt="droite" src="/public/images/uddeim/format_right.gif" style="cursor: pointer;" name="addbbcode4" onclick="bbstyle(36, $(\''.$champ.'\')); textCount($(\''.$champ.'\'),$(\'characterstyped\'),'.$nbMax.'); return false;" title="Tags BB Code pour définir du texte à droite. Utilisation : [right]texte[/right]"></td>';
		$retour .='						<td><img alt="justifié" src="/public/images/uddeim/format_justify.gif" style="cursor: pointer;" name="addbbcode4" onclick="bbstyle(38, $(\''.$champ.'\')); textCount($(\''.$champ.'\'),$(\'characterstyped\'),'.$nbMax.'); return false;" title="Tags BB Code pour définir du texte justifié. Utilisation : [justify]texte[/justify]"></td>';
		$retour .='						<td>&nbsp;</td>';
		$retour .='						<td><img alt="liste ul" src="/public/images/uddeim/format_listul.gif" style="cursor: pointer;" name="addbbcode4" onclick="bbstyle(22, $(\''.$champ.'\')); textCount($(\''.$champ.'\'),$(\'characterstyped\'),'.$nbMax.'); return false;" title="Tags BB Code pour définir une liste. Utilisation : [ul][li]...[/li][/ul]"></td>';
		$retour .='						<td><img alt="element de liste li" src="/public/images/uddeim/format_listul.gif" style="cursor: pointer;" name="addbbcode4" onclick="bbstyle(30, $(\''.$champ.'\')); textCount($(\''.$champ.'\'),$(\'characterstyped\'),'.$nbMax.'); return false;" title="Tags BB Code pour définir une liste. Utilisation : [li]texte[/li]"></td>';
		$retour .='						<td>&nbsp;</td>';
