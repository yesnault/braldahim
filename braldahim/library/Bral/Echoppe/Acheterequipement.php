...
class Bral_Echoppe_Acheterequipement extends Bral_Echoppe_Echoppe {
	...
	private function prepareEquipement($idEquipement) {
		...
		$tabEquipement = array(
			...
			"armure" => $this->equipement["armure_equipement"],
			"force" => $this->equipement["force_equipement"],
			"agilite" => $this->equipement["agilite_equipement"],
			"vigueur" => $this->equipement["vigueur_equipement"],
			"sagesse" => $this->equipement["sagesse_equipement"],
			"vue" => $this->equipement["vue_recette_equipement"],
			"attaque" => $this->equipement["attaque_equipement"],
			"degat" => $this->equipement["degat_equipement"],
			"defense" => $this->equipement["defense_equipement"],
	...
	function prepareResultat() {
		...
		$details = "[b".$this->view->user->id_braldun."] a acheté la pièce d'équipement n°".$this->view->equipement["id_equipement"]. " dans l'échoppe";
