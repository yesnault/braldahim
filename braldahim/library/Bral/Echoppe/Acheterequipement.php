...
class Bral_Echoppe_Acheterequipement extends Bral_Echoppe_Echoppe {
	...
	private function prepareEquipement($idEquipement) {
		...
		$tabEquipement = array(
			...
			"vernis_bm_vue" => $this->equipement["vernis_bm_vue_equipement_bonus"],
			"vernis_bm_armure" => $this->equipement["vernis_bm_armure_equipement_bonus"],
			"vernis_bm_poids" => $this->equipement["vernis_bm_poids_equipement_bonus"],
			"vernis_bm_agilite" => $this->equipement["vernis_bm_agilite_equipement_bonus"],
			"vernis_bm_force" => $this->equipement["vernis_bm_force_equipement_bonus"],
			"vernis_bm_sagesse" => $this->equipement["vernis_bm_sagesse_equipement_bonus"],
			"vernis_bm_vigueur" => $this->equipement["vernis_bm_vigueur_equipement_bonus"],
			"vernis_bm_attaque" => $this->equipement["vernis_bm_attaque_equipement_bonus"],
			"vernis_bm_degat" => $this->equipement["vernis_bm_degat_equipement_bonus"],
			"vernis_bm_defense" => $this->equipement["vernis_bm_defense_equipement_bonus"],
