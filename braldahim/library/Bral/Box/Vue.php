					...
					if ($echoppes != null) {
						foreach($echoppes as $e) {
							if ($display_x == $e["x_echoppe"] && $display_y == $e["y_echoppe"]) {
								...
								$tabEchoppes[] = array("id_echoppe" => $e["id_echoppe"], "nom_echoppe" => $e["nom_echoppe"], "nom_metier" => $nom_metier, "nom_hobbit" => $e["nom_hobbit"], "prenom_hobbit" => $e["prenom_hobbit"], "id_hobbit" => $e["id_hobbit"]);
							}
						}
					}
