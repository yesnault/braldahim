 ...
 */
class Bral_Monstres_Competences_Souffledelombre extends Bral_Monstres_Competences_Attaque {
	...
	protected function getDetailsBot($malus, $pvEnMoins, $jetMonstre, $jetBraldun) {
		...
		$retour = "";
		$retour .= $this->monstre["nom_type_monstre"] ." (".$this->monstre["id_monstre"].") a effectué un souffle de l'ombre :";
