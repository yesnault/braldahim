...
class Bral_Monstres_Competences_Coupdetentacule extends Bral_Monstres_Competences_Attaque {
	...
	public function actionSpecifique() {
		...
		Bral_Util_Effets::ajouteEtAppliqueEffetHobbit($this->cible["id_hobbit"], Bral_Util_Effets::CARACT_PV, Bral_Util_Effets::TYPE_MALUS, $nbTours, $malus, "Coup de tentacule empoisonnée");
	...
	private function majEvenement($hobbit, $malus, $nbTours, $jetMonstre, $jetHobbit) {
		...
		$details = "[m".$this->monstre["id_monstre"]."] donne un coup de tentacule empoisonnée sur le hobbit [h".$hobbit["id_hobbit"]."]";
