...
class Bral_Monstres_Competences_Jetdeau extends Bral_Monstres_Competences_Attaque {
	...
	public function actionSpecifique() {
		...
		Bral_Util_Effets::ajouteEtAppliqueEffetHobbit($this->cible["id_hobbit"], Bral_Util_Effets::CARACT_FORCE, Bral_Util_Effets::TYPE_MALUS, $nbTours, $malus, "Jet d'eau");
	...
	private function majEvenement($hobbit, $malus, $nbTours, $jetMonstre, $jetHobbit) {
		...
		$details = "[m".$this->monstre["id_monstre"]."] a effectué un jet d'eau sur hobbit [h".$hobbit["id_hobbit"]."]";
