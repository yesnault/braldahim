...
class Bral_Monstres_VieSolitaire {
    ...
    private function rechercheNouvelleCible(&$monstre) {
    	...
    	$hobbitTable = new Hobbit();
		$cibles = $hobbitTable->findLesPlusProches($monstre["x_monstre"], $monstre["y_monstre"], $monstre["vue_monstre"], 1, $monstre["id_fk_type_monstre"]);
		if ($cibles != null) {
			$cible = $cibles[0];
   ...
   /**
     ...
     */
    protected function deplacementSolitaire(&$monstre) {
