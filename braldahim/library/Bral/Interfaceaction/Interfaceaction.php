 ...
 */
abstract class Bral_Interfaceaction_Interfaceaction
{
	...
	function render()
	{
		...
		switch ($this->action) {
			case "ask":
				return $this->view->render("Interfaceaction/" . $this->nom_systeme . "_formulaire.phtml");
				break;
			case "do":
				$this->view->reloadInterface = $this->reloadInterface;
				$texte = $this->view->render("Interfaceaction/" . $this->nom_systeme . "_resultat.phtml");
