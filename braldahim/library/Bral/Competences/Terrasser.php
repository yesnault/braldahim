...
class Bral_Competences_Terrasser extends Bral_Competences_Competence {
	...
	private function calculEvenementRune() {
		...
		Bral_Monstres_VieMonstre::dropRune($this->view->user->x_hobbit, $this->view->user->y_hobbit, $this->view->user->niveau_hobbit, $this->view->user->niveau_hobbit, $this->view->config->game->groupe_monstre->type->nuee);
	}
