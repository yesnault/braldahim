 ...
 * $LastChangedBy$
 */
abstract class Bral_Administrationajax_Administrationajax {
	...
	function render() {
		...
		switch($this->action) {
			case "ask":
				return $this->view->render("Administrationajax/".$this->nom_systeme."_formulaire.phtml");
				break;
			case "do":
				$this->view->reloadInterface = $this->reloadInterface;
				$texte = $this->view->render("Administrationajax/".$this->nom_systeme."_resultat.phtml");
