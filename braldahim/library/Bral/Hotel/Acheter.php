...
class Bral_Hotel_Acheter extends Bral_Hotel_Hotel {
	...
	private function prepareVenteEquipement($idVente) {
		...
		$tabEquipement = array(
			...
			"armure" => $equipement["armure_equipement"],
			"force" => $equipement["force_equipement"],
			"agilite" => $equipement["agilite_equipement"],
			"vigueur" => $equipement["vigueur_equipement"],
			"sagesse" => $equipement["sagesse_equipement"],
			"vue" => $equipement["vue_recette_equipement"],
			"attaque" => $equipement["attaque_equipement"],
			"degat" => $equipement["degat_equipement"],
			"defense" => $equipement["defense_equipement"],
