...
class Bral_Hotel_Acheter extends Bral_Hotel_Hotel {
	...
	private function prepareVenteEquipement($idVente) {
		...
		$tabEquipement = array(
			...
			"vernis_bm_vue" => $equipement["vernis_bm_vue_equipement_bonus"],
			"vernis_bm_armure" => $equipement["vernis_bm_armure_equipement_bonus"],
			"vernis_bm_poids" => $equipement["vernis_bm_poids_equipement_bonus"],
			"vernis_bm_agilite" => $equipement["vernis_bm_agilite_equipement_bonus"],
			"vernis_bm_force" => $equipement["vernis_bm_force_equipement_bonus"],
			"vernis_bm_sagesse" => $equipement["vernis_bm_sagesse_equipement_bonus"],
			"vernis_bm_vigueur" => $equipement["vernis_bm_vigueur_equipement_bonus"],
			"vernis_bm_attaque" => $equipement["vernis_bm_attaque_equipement_bonus"],
			"vernis_bm_degat" => $equipement["vernis_bm_degat_equipement_bonus"],
			"vernis_bm_defense" => $equipement["vernis_bm_defense_equipement_bonus"],
			"est_charrette" => false,
			"charrette_possible" => true,
		);
